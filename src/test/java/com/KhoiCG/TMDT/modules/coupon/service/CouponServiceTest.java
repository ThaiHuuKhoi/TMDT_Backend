...
class CouponServiceTest {
    ...
    void applyCoupon_SuccessPercentage() {
        ...
        assertEquals(20000L, response.getDiscountAmount());
        assertEquals(180000L, response.getFinalPrice());
    }
